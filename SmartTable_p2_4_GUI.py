...
import sys
import SmartTable_p2_4_GUI_support
import SmartTable_p2_4
...
def vp_start_gui():
	...
	SmartTable_p2_4_GUI_support.init(root, top)
	root.resizable(0,0)
	# root.after(100, SmartTable_p2_4.loopTest)
	root.mainloop()
...
def create_Smart_Table(root, *args, **kwargs):
	...
	w = Toplevel (root)
	top = Smart_Table (w)
	SmartTable_p2_4_GUI_support.init(w, top, *args, **kwargs)
	return (w, top)
...
class Smart_Table:
	...
	def runMeasuring(self):
		...
		# 	messagebox.showerror("Input Error", "Please enter valid Measurement Values for all fields")
			...
			SmartTable_p2_4.getMeasurements(sN, sz, bH, bHT, bW, bWT, bS, bST, bNW, bNWT)
	...
	def __init__(self, top=None):
		...
		top.iconbitmap("MASKreedaNMC_1.ico")
		...
		self.cnvsData.place(relx=0.03, rely=0.025, relheight=0.75, relwidth=0.94)
		...
		self.lblTol.place(relx=0.69, rely=0.37, height=21, width=104)
		...
		self.lblBodyHeight.place(relx=0.055, rely=0.46, height=21, width=114)
		...
		self.lblBodyWidth.place(relx=0.06, rely=0.60, height=21, width=108)
		...
		self.lblBodySweap.place(relx=0.06, rely=0.74, height=21, width=110)
		...
		self.lblBackNeckWidth.place(relx=0.06, rely=0.88, height=21, width=136)
		...
		# self.btnRun.configure(command=SmartTable_p2_4.getMeasurements)
		...
		# self.btnStop.configure(command=SmartTable_p2_4.testing)
