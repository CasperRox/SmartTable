...
import SmartTable_GUI_1_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = Tk()
    SmartTable_GUI_1_support.set_Tk_var()
    top = Smart_Table (root)
    SmartTable_GUI_1_support.init(root, top)
    root.mainloop()
...
def create_Smart_Table(root, *args, **kwargs):
    ...
    SmartTable_GUI_1_support.set_Tk_var()
    top = Smart_Table (w)
    SmartTable_GUI_1_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Smart_Table:
    def __init__(self, top=None):
        ...
        self.txtStyleNo.configure(textvariable=SmartTable_GUI_1_support.Enter)
        ...
        self.btnRun.configure(state=ACTIVE)
        ...
        self.btnStop.configure(state=ACTIVE)
