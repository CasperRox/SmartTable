...
# 	whiteMode = wM
	...
	while(True):
		...
		if ret:
			...
			frame = cv2.resize(frame, (int(width*0.5),int(height*0.7)))
			# frame = frame[150:590, 0:480]
...
targetBodyHeight = 73.5
targetBodyHeightTol = 1.5
targetBodyWidth = 52.0
targetBodyWidthTol = 1.5
targetBodySweap = 52.0
targetBodySweapTol = 1.5
targetBackNeckWidth = 17.6
targetBackNeckWidthTol = 1.0
